...
export type Command = InstaQLEntity<AppSchema, "commands">;
export type SandboxPackage = InstaQLEntity<AppSchema, "sandboxPackages">;
...
export const commandTx = (commandId: string) => {
...
export const sandboxPackageTx = (sandboxPackageId: string) => {
