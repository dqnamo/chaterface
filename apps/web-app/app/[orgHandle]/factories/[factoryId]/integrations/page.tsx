...
import {
	SettingsPageShell,
	SettingsSection,
} from "../settings/_components/SettingsPageShell";
import {
	getApiErrorMessage,
	type IntegrationConnection,
	integrationConnectionTx,
} from "../settings/_lib/factory-settings";

export default function FactoryIntegrationsPage() {
					...
					<div className="flex items-center justify-between gap-3 border-t border-grayscale-4 p-3">
						<div className="min-w-0">
							...
							<p className="text-xs text-grayscale-10">
								Requires Slack OAuth credentials and a configured Events API
								URL.
							</p>
						</div>
						<Button
