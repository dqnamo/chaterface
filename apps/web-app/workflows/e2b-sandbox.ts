...
export class E2BSandbox {
	...
	static async create(template?: string, options?: SandboxCreateOptions) {
		...
		const sandbox = template
			? await E2BSdkSandbox.create(template, createOptions)
			: await E2BSdkSandbox.create(createOptions);
